...
NFO_BFO_SESSION_START = time(9, 0)
NFO_BFO_SESSION_END = time(15, 30)
MCX_EVENING_SESSION_START = time(15, 30)
MCX_EVENING_SESSION_END = time(23, 30)
...
def derivative_exchanges_open(now: datetime | None = None) -> frozenset[str]:
    ...
    if MCX_EVENING_SESSION_START < current <= MCX_EVENING_SESSION_END:
